        ...
        <div className="flex items-center justify-between w-full">
          ...
          <div className="flex justify-end gap-4">
            <Link to="/dispute/create">
              <button type="button" className="text-raisin-black bg-primary/90 p-4 hover:bg-primary">Create dispute
              </button>
            </Link>
                  ...
                  <table className="min-w-full divide-y divide-primary">
                    ...
                    {disputes?.map(({id, state, owner, defendant,}) => <tr key={id}
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-end text-sm font-medium flex gap-2 justify-end">
                        <Link to={`/dispute/${id}`}>
                          <button type="button" className="text-raisin-black bg-primary/90 py-2 px-4 hover:bg-primary">
                            Show
                          </button>
                        </Link>
                        ...
                        {state === 'Created' && <Form method="post">
                          ...
                          <button type="submit" name="_action" value={'removeDispute'}
                                  className="text-raisin-black bg-primary/90 py-2 px-4 hover:bg-primary">
